...
open class DorwinionGenst : LOTRVillageGen(LOTRBiome.forodwaith) {
	init {
		gridScale = 12
	...
	open class Instance(
		village: DorwinionGenst, world: World, i: Int, k: Int, random: Random, loc: LocationInfo
	) : AbstractInstance<DorwinionGenst>(village, world, i, k, random, loc) {
