...
import com.github.hummel.genst.world.structure.DolGuldurTower
...
class DolGuldurGenst : LOTRVillageGen(LOTRBiome.forodwaith) {
	init {
		gridScale = 12
	...
	class Instance(
		village: DolGuldurGenst, world: World, i: Int, k: Int, random: Random, loc: LocationInfo
	) : AbstractInstance<DolGuldurGenst>(village, world, i, k, random, loc) {

		override fun addVillageStructures(random: Random) {
			addStructure(DolGuldurTower(), 0, 6, 2, true)
