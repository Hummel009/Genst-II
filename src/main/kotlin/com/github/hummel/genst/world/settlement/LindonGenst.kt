...
import com.github.hummel.genst.world.structure.LindonTower
...
open class LindonGenst : LOTRVillageGen(LOTRBiome.forodwaith) {
	init {
		gridScale = 12
	...
	open class Instance(
		village: LindonGenst, world: World, i: Int, k: Int, random: Random, loc: LocationInfo
	) : AbstractInstance<LindonGenst>(village, world, i, k, random, loc) {
		...
		open fun getTower(): LOTRWorldGenStructureBase2 = LindonTower()
	}
}