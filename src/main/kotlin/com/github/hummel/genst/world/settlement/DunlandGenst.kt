...
class DunlandGenst : LOTRVillageGen(LOTRBiome.forodwaith) {
	init {
		gridScale = 12
	...
	class Instance(
		village: DunlandGenst, world: World, i: Int, k: Int, random: Random, loc: LocationInfo
	) : AbstractInstance<DunlandGenst>(village, world, i, k, random, loc) {
