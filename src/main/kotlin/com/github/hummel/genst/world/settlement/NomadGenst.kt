...
open class NomadGenst : LOTRVillageGen(LOTRBiome.forodwaith) {
	init {
		gridScale = 12
	...
	class Instance(
		village: NomadGenst, world: World, i: Int, k: Int, random: Random, loc: LocationInfo
	) : AbstractInstance<NomadGenst>(village, world, i, k, random, loc) {
