...
import com.github.hummel.genst.world.structure.GundabadWargPit
import com.github.hummel.genst.world.structure.GundabadTower
...
class GundabadGenst : LOTRVillageGen(LOTRBiome.forodwaith) {
	init {
		gridScale = 12
	...
	class Instance(
		village: GundabadGenst, world: World, i: Int, k: Int, random: Random, loc: LocationInfo
	) : AbstractInstance<GundabadGenst>(village, world, i, k, random, loc) {

		override fun addVillageStructures(random: Random) {
			addStructure(GundabadTower(), 0, 6, 2, true)
			...
			addStructure(GundabadWargPit(false), -21, 0, 1, true)
			addStructure(GundabadWargPit(false), 0, -21, 2, true)
			addStructure(GundabadWargPit(false), 21, 0, 3, true)
			addStructure(GundabadWargPit(false), 0, 21, 0, true)
			val houses = 20
