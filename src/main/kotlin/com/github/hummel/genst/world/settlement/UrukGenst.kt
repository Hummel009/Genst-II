...
import com.github.hummel.genst.world.structure.UrukTower
...
class UrukGenst : LOTRVillageGen(LOTRBiome.forodwaith) {
	init {
		gridScale = 12
	...
	class Instance(
		village: UrukGenst, world: World, i: Int, k: Int, random: Random, loc: LocationInfo
	) : AbstractInstance<UrukGenst>(village, world, i, k, random, loc) {

		override fun addVillageStructures(random: Random) {
			addStructure(UrukTower(), 0, 6, 2, true)
