...
import com.github.hummel.genst.world.structure.RuinedTower
...
open class RuinedCityGenst : LOTRVillageGen(LOTRBiome.forodwaith) {
	init {
		gridScale = 12
	...
	open class Instance(
		village: RuinedCityGenst, world: World, i: Int, k: Int, random: Random, loc: LocationInfo
	) : AbstractInstance<RuinedCityGenst>(village, world, i, k, random, loc) {
		...
		override fun addVillageStructures(random: Random) {
			...
			val mansionX = 12
			val mansionZ = 20
			addStructure(RuinedTower(false), 0, 0, 2, true)
