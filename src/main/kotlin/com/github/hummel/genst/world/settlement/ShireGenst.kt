...
class ShireGenst : LOTRVillageGen(LOTRBiome.forodwaith) {
	init {
		gridScale = 12
	...
	class Instance(
		village: ShireGenst, world: World, i: Int, k: Int, random: Random, loc: LocationInfo
	) : AbstractInstance<ShireGenst>(village, world, i, k, random, loc) {
