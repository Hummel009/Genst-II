...
open class GulfGenst : LOTRVillageGen(LOTRBiome.forodwaith) {
	init {
		gridScale = 12
	...
	class Instance(
		village: GulfGenst, world: World, i: Int, k: Int, random: Random, loc: LocationInfo
	) : AbstractInstance<GulfGenst>(village, world, i, k, random, loc) {
