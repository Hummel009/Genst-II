...
import com.github.hummel.genst.world.structure.MordorTower
...
class MordorGenst : LOTRVillageGen(LOTRBiome.forodwaith) {
	init {
		gridScale = 12
	...
	class Instance(
		village: MordorGenst, world: World, i: Int, k: Int, random: Random, loc: LocationInfo
	) : AbstractInstance<MordorGenst>(village, world, i, k, random, loc) {

		override fun addVillageStructures(random: Random) {
			addStructure(MordorTower(), 0, 6, 2, true)
