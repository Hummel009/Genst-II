...
class HarnennorGenst : LOTRVillageGen(LOTRBiome.forodwaith) {
	init {
		gridScale = 12
	...
	class Instance(
		village: HarnennorGenst, world: World, i: Int, k: Int, random: Random, loc: LocationInfo
	) : AbstractInstance<HarnennorGenst>(village, world, i, k, random, loc) {
