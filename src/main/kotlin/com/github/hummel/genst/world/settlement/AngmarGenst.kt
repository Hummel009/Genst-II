...
import com.github.hummel.genst.world.structure.AngmarTower
...
class AngmarGenst : LOTRVillageGen(LOTRBiome.forodwaith) {
	init {
		gridScale = 12
	...
	class Instance(
		village: AngmarGenst, world: World, i: Int, k: Int, random: Random, loc: LocationInfo
	) : AbstractInstance<AngmarGenst>(village, world, i, k, random, loc) {

		override fun addVillageStructures(random: Random) {
			addStructure(AngmarTower(), 0, 6, 2, true)
