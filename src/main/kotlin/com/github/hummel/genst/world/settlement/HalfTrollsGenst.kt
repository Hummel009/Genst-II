...
open class HalfTrollsGenst : LOTRVillageGen(LOTRBiome.forodwaith) {
	init {
		gridScale = 12
	...
	open class Instance(
		village: HalfTrollsGenst, world: World, i: Int, k: Int, random: Random, loc: LocationInfo
	) : AbstractInstance<HalfTrollsGenst>(village, world, i, k, random, loc) {
