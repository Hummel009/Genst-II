...
class DaleGenst : LOTRVillageGen(LOTRBiome.forodwaith) {
	init {
		gridScale = 12
	...
	class Instance(
		village: DaleGenst, world: World, i: Int, k: Int, random: Random, loc: LocationInfo
	) : AbstractInstance<DaleGenst>(village, world, i, k, random, loc) {
