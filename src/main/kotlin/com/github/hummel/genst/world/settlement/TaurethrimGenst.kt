...
open class TaurethrimGenst : LOTRVillageGen(LOTRBiome.forodwaith) {
	init {
		gridScale = 12
	...
	open class Instance(village: TaurethrimGenst, world: World, i: Int, k: Int, random: Random, loc: LocationInfo) :
		AbstractInstance<TaurethrimGenst>(village, world, i, k, random, loc) {
