...
open class SingleGenst : LOTRVillageGen(LOTRBiome.forodwaith) {
	init {
		gridScale = 12
	...
	open class Instance(
		village: SingleGenst, world: World, i: Int, k: Int, random: Random, loc: LocationInfo
	) : AbstractInstance<SingleGenst>(village, world, i, k, random, loc) {
