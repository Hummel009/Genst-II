...
open class MorwaithGenst : LOTRVillageGen(LOTRBiome.forodwaith) {
	init {
		gridScale = 12
	...
	open class Instance(
		village: MorwaithGenst, world: World, i: Int, k: Int, random: Random, loc: LocationInfo
	) : AbstractInstance<MorwaithGenst>(village, world, i, k, random, loc) {
