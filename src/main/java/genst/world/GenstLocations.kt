...
object GenstLocations {
	...
	fun postInit() {
		...
		affix(location, LOTRWaypoint.BYWATER, 0.0, 0.0, Dir.EAST)
		affix(location, LOTRWaypoint.DEEPHALLOW, 0.0, 0.0, Dir.NORTH)
		affix(location, LOTRWaypoint.FROGMORTON, 0.0, 0.0, Dir.NORTH)
		affix(location, LOTRWaypoint.GREENHOLM, 0.0, 0.0, Dir.EAST)
		affix(location, LOTRWaypoint.HAYSEND, 0.0, 0.0, Dir.NORTH)
		affix(location, LOTRWaypoint.HAY_GATE, 0.0, 0.0, Dir.NORTH)
		affix(location, LOTRWaypoint.HOBBITON, 0.0, 0.0, Dir.NORTH)
		affix(location, LOTRWaypoint.LITTLE_DELVING, 0.0, 0.0, Dir.EAST)
		affix(location, LOTRWaypoint.LONGBOTTOM, 0.0, 0.0, Dir.NORTH)
		affix(location, LOTRWaypoint.MICHEL_DELVING, 0.0, 0.0, Dir.EAST)
		affix(location, LOTRWaypoint.NEEDLEHOLE, 0.0, 0.0, Dir.EAST)
		affix(location, LOTRWaypoint.NOBOTTLE, 0.0, 0.0, Dir.EAST)
		affix(location, LOTRWaypoint.OATBARTON, 0.0, 0.0, Dir.NORTH)
		affix(location, LOTRWaypoint.OVERHILL, 0.0, 0.0, Dir.NORTH)
		affix(location, LOTRWaypoint.SCARY, 0.0, 0.0, Dir.NORTH)
		affix(location, LOTRWaypoint.STOCK, 0.0, 0.0, Dir.NORTH)
		affix(location, LOTRWaypoint.TIGHFIELD, 0.0, 0.0, Dir.NORTH)
		affix(location, LOTRWaypoint.TUCKBOROUGH, 0.0, 0.0, Dir.EAST)
		...
		/* READY */
		location = LOTRVillageGenHighElven()
		affix(location, LOTRWaypoint.FORLOND, 0.0, 0.0, Dir.NORTH)
		affix(location, LOTRWaypoint.HARLOND, 0.0, 0.0, Dir.NORTH)
		affix(location, LOTRWaypoint.AMON_EREB, 0.0, 0.0, Dir.NORTH)
		affix(location, LOTRWaypoint.MITHLOND_NORTH, 0.0, 0.0, Dir.NORTH)
		affix(location, LOTRWaypoint.MITHLOND_SOUTH, 0.0, 0.0, Dir.NORTH)
		affix(location, LOTRWaypoint.FORLINDON, 0.0, 0.0, Dir.NORTH)
		affix(location, LOTRWaypoint.HARLINDON, 0.0, 0.0, Dir.NORTH)
		affix(location, LOTRWaypoint.TOWER_HILLS, 0.0, 0.0, Dir.NORTH)
		affix(location, LOTRWaypoint.TOWER_HILLS, 0.0, 0.0, Dir.NORTH)
