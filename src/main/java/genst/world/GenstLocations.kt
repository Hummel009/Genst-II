...
object GenstLocations {
	...
	fun postInit() {
		...
		affix(location, LOTRWaypoint.MICHEL_DELVING, 0.0, 0.3, Dir.SOUTH)
		affix(location, LOTRWaypoint.LITTLE_DELVING, 0.0, -0.3, Dir.NORTH)
		affix(location, LOTRWaypoint.NOBOTTLE, 0.0, -0.3, Dir.NORTH)
		affix(location, LOTRWaypoint.NEEDLEHOLE, 0.2, 0.0, Dir.EAST)
		affix(location, LOTRWaypoint.TUCKBOROUGH, -0.2, 0.0, Dir.WEST)
		affix(location, LOTRWaypoint.BYWATER, 0.0, 0.3, Dir.SOUTH)
		affix(location, LOTRWaypoint.FROGMORTON, 0.0, 0.3, Dir.SOUTH)
		...
		affix(location, LOTRWaypoint.BUCKLEBURY, 0.3, 0.0, Dir.EAST)
		affix(location, LOTRWaypoint.DEEPHALLOW, 0.3, 0.0, Dir.EAST)
		affix(location, LOTRWaypoint.STOCK, 0.3, 0.0, Dir.EAST)
		affix(location, LOTRWaypoint.HOBBITON, -0.2, 0.0, Dir.WEST)
		...
		affix(location, LOTRWaypoint.WAYMEET, 0.5, -0.5, Dir.NORTH)
		affix(location, LOTRWaypoint.WHITFURROWS, 0.5, -0.5, Dir.NORTH)
