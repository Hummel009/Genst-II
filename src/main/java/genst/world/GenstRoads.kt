...
object GenstRoads {
	...
	fun postInit() {
		...
		registerRoad(LOTRWaypoint.NORTH_ITHILIEN.linkTo(ruinedCity - 0.1, 0.0))
		...
		registerRoadI(LOTRWaypoint.HARNEN_ROAD_TOWN.linkTo(0.3, -harnennor + 0.4), false)
