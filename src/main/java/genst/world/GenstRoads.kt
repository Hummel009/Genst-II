...
object GenstRoads {
	...
	fun postInit() {
		...
		registerRoad(LOTRWaypoint.ENEDWAITH_ROAD.linkTo(ruinedCity - 0.1, 0.0))
		...
		registerRoad(LOTRWaypoint.HELMS_DEEP.linkTo(0.0, rohanFort - 0.5))
		...
		registerRoad(LOTRWaypoint.THARBAD.linkTo(-ruinedCity, -0.3))
		...
		registerRoadI(LOTRWaypoint.HELMS_CROSSROADS.linkTo(0.3, -rohanFort + 0.3), false)
		...
		registerRoadI(LOTRWaypoint.MICHEL_DELVING.linkTo(0.1, basicVillage - 0.6), false)
		...
		registerRoadI(LOTRWaypoint.WAYMEET.linkTo(-basicVillage + 0.3, -0.55), true)
