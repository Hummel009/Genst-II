...
object GenstRoads {
	fun postInit() {
		...
		registerRoadI(LOTRWaypoint.JUNGLE_CITY_CAPITAL.linkTo(-0.5, -taurethrim), false)
		registerRoadI(LOTRWaypoint.JUNGLE_CITY_CAVES.linkTo(-taurethrim + 0.1, -0.1), true)
		registerRoadI(LOTRWaypoint.JUNGLE_CITY_EAST.linkTo(taurethrim, -0.5), true)
		registerRoadI(LOTRWaypoint.JUNGLE_CITY_STONE.linkTo(0.2, -taurethrim + 0.1), false)
