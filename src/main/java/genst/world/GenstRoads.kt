...
object GenstRoads {
	...
	fun postInit() {
		...
		registerRoad("Linker", arrayOf(LOTRWaypoint.MICHEL_DELVING, LOTRWaypoint.MICHEL_DELVING.info(0.0, 0.3)))
		registerRoad("Linker", arrayOf(LOTRWaypoint.LITTLE_DELVING, LOTRWaypoint.LITTLE_DELVING.info(0.0, -0.3)))
		registerRoad("Linker", arrayOf(LOTRWaypoint.NOBOTTLE, LOTRWaypoint.NOBOTTLE.info(0.0, -0.3)))
		...
		registerRoad("Linker", arrayOf(LOTRWaypoint.BYWATER, LOTRWaypoint.BYWATER.info(0.0, 0.3)))
		registerRoad("Linker", arrayOf(LOTRWaypoint.FROGMORTON, LOTRWaypoint.FROGMORTON.info(0.0, 0.3)))
		...
		registerRoad("Linker", arrayOf(LOTRWaypoint.BUCKLEBURY, LOTRWaypoint.BUCKLEBURY.info(0.3, 0.0)))
		registerRoad("Linker", arrayOf(LOTRWaypoint.DEEPHALLOW, LOTRWaypoint.DEEPHALLOW.info(0.3, 0.0)))
		registerRoad("Linker", arrayOf(LOTRWaypoint.STOCK, LOTRWaypoint.STOCK.info(0.3, 0.0)))
		registerRoad("Linker", arrayOf(LOTRWaypoint.HOBBITON, LOTRWaypoint.HOBBITON.info(-0.2, 0.0)))
		...
		registerRoad("Linker", arrayOf(LOTRWaypoint.WAYMEET, LOTRWaypoint.WAYMEET.info(0.5, -0.5)))
		registerRoad("Linker", arrayOf(LOTRWaypoint.WHITFURROWS, LOTRWaypoint.WHITFURROWS.info(0.5, -0.5)))
	}
}