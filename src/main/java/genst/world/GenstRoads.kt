...
object GenstRoads {
	...
	fun postInit() {
		...
		registerRoad("Linker", arrayOf(LOTRWaypoint.LONGBOTTOM.info(0.5, -0.5), LOTRWaypoint.LONGBOTTOM.info(0.5, -0.7)))
		registerRoad("Linker", arrayOf(LOTRWaypoint.WAYMEET, LOTRWaypoint.WAYMEET.info(0.55, -0.55)))
		registerRoad("Linker", arrayOf(LOTRWaypoint.WAYMEET.info(0.55, -0.55), LOTRWaypoint.WAYMEET.info(0.55, -0.75)))
		registerRoad("Linker", arrayOf(LOTRWaypoint.WHITFURROWS, LOTRWaypoint.WHITFURROWS.info(0.5, -0.5)))
		registerRoad("Linker", arrayOf(LOTRWaypoint.WHITFURROWS.info(0.5, -0.5), LOTRWaypoint.WHITFURROWS.info(0.5, -0.7)))
	}
}