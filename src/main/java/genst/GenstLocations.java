...
public class GenstLocations {
	public static Set<LOTRVillageGen> locations = new HashSet<>();

	public static void affix(LOTRVillageGen inst, LOTRWaypoint wp, int addX, int addZ, int rotation) {
	...
	public static void postInit() {
		LOTRVillageGen gondorFortPG = new LOTRVillageGenGondor(LOTRBiome.ocean, LOTRWorldGenGondorStructure.GondorFiefdom.PINNATH_GELIN, 0.0F) {
			@Override
		...
		LOTRVillageGen gondorFort = new LOTRVillageGenGondor(LOTRBiome.ocean, LOTRWorldGenGondorStructure.GondorFiefdom.GONDOR, 0.0F) {
			@Override
			public LOTRVillageGen.AbstractInstance<?> createVillageInstance(World world, int i, int k, Random random, LocationInfo loc) {
				return new Instance(this, world, i, k, random, loc) {
