...
class LOTRVillageGenDunedain(biome: LOTRBiome?, f: Float) : LOTRVillageGen(biome) {
	init {
		gridScale = 12
	...
	class Instance(
		village: LOTRVillageGenDunedain?, world: World?, i: Int, k: Int, random: Random?, loc: LocationInfo?
	) : AbstractInstance<LOTRVillageGenDunedain?>(village, world, i, k, random, loc) {
