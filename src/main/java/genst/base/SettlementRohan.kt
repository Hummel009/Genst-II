...
class SettlementRohan(biome: LOTRBiome?, f: Float) : LOTRVillageGen(biome) {
	...
	class Instance(village: SettlementRohan?, world: World?, i: Int, k: Int, random: Random?, loc: LocationInfo?) :
		AbstractInstance<SettlementRohan?>(village, world, i, k, random, loc) {
