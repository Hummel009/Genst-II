...
object GenstLocations {
	...
	private fun affix(inst: LOTRVillageGen, wp: LOTRWaypoint, addX: Int, addZ: Int, rotation: Int) {
		GenstLogger.skip.add(wp)
		inst.addFixedLocation(
			wp, addX * LOTRGenLayerWorld.scale, addZ * LOTRGenLayerWorld.scale, rotation, "PLACEHOLDER"
		)
		locations.add(inst)
	}
