...
public class LOTRVillageGenRuinsSmallStone extends LOTRVillageGen {

	public LOTRVillageGenRuinsSmallStone(LOTRBiome biome, float f) {
		super(biome);
		gridScale = 14;
	...
	public static class Instance extends LOTRVillageGen.AbstractInstance<LOTRVillageGenRuinsSmallStone> {
		public Instance(LOTRVillageGenRuinsSmallStone village, World world, int i, int k, Random random, LocationInfo loc) {
