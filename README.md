Genst II - это аддон к моду "Властелин колец" для Minecraft. По своей сути, это переосмысление и альтернатива моего проекта Genstructures Official.
...
Для запуска и редактирования проекта потребуется среда разработки Kotlin и JDK. Подойдёт ***IntelliJ IDEA***, а также ***JDK 1.8.0_382***. Чтобы приступить к работе, необходимо импортировать папку как Gradle-проект.
