...
* В папке есть два батника, `setupEclipse` и `setupIdea`. Выбираем нужный, запускаем, ждём окончания. ***Спойлер: Eclipse с языком Kotlin работает очень плохо, но выбор ваш.***
